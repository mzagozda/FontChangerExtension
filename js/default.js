! function(a, b) {
    ...
    function u(a, b, c, d) {
        for (var e = c === (d ? "border" : "content") ? 4 : "width" === b ? 1 : 0, f = 0; 4 > e; e += 2) "margin" === c && (f += $.css(a, c + pb[e], !0)), d ? ("content" === c && (f -= parseFloat(cb(a, "padding" + pb[e])) || 0), "margin" !== c && (f -= parseFloat(cb(a, "border" + pb[e] + "Width")) || 0)) : (f += parseFloat(cb(a, "padding" + pb[e])) || 0, "padding" !== c && (f += parseFloat(cb(a, "border" + pb[e] + "Width")) || 0));
        return f
    }
    ...
    function v(a, b, c) {
        ...
        if (0 >= d) {
            if (d = cb(a, b), (0 > d || null == d) && (d = a.style[b]), kb.test(d)) return d;
    ...
    function w(a) {
        ...
        return b.remove(), ("none" === c || "" === c) && (db = P.body.appendChild(db || $.extend(P.createElement("iframe"), {
            ...
            width: 0,
            height: 0
        })), eb && db.createElement || (eb = (db.contentWindow || db.contentDocument).document, eb.write("<!doctype html><html><body>"), eb.close()), b = eb.body.appendChild(eb.createElement(a)), c = cb(b, "display"), P.body.removeChild(db)), mb[a] = c, c
    }
    ...
    function z(a, c, d, e, f, g) {
        ...
        for (var h, i = a[f], j = 0, k = i ? i.length : 0, l = a === Jb; k > j && (l || !h); j++) h = i[j](c, d, e), "string" == typeof h && (!l || g[h] ? h = b : (c.dataTypes.unshift(h), h = z(a, c, d, e, h, g)));
    ...
    function G(a, b) {
        $.each(b, function(b, c) {
            for (var d = ($b[b] || []).concat($b["*"]), e = 0, f = d.length; f > e; e++)
    ...
    function H(a, b, c) {
        var d, e = 0,
            ...
            h = function() {
                for (var b = Ub || F(), c = Math.max(0, i.startTime + i.duration - b), d = 1 - (c / i.duration || 0), e = 0, f = i.tweens.length; f > e; e++) i.tweens[e].run(d);
    ...
    function L(a, b) {
        for (var c, d = {
                height: a
            }, e = 0; 4 > e; e += 2 - b) c = pb[e], d["margin" + c] = d["padding" + c] = a;
    ...
    $.fn.extend({
                ...
                for (c = (a || "").split(ba), h = 0, i = this.length; i > h; h++)
                    if (e = this[h], 1 === e.nodeType && e.className) {
                        for (d = (" " + e.className + " ").replace(ua, " "), f = 0, g = c.length; g > f; f++)
                            for (; d.indexOf(" " + c[f] + " ") > -1;) d = d.replace(" " + c[f] + " ", " ");
        ...
        hasClass: function(a) {
            for (var b = " " + a + " ", c = 0, d = this.length; d > c; c++)
                if (1 === this[c].nodeType && (" " + this[c].className + " ").replace(ua, " ").indexOf(b) > -1) return !0;
            return !1
        },
        val: function(a) {
            var c, d, e, f = this[0];
    ...
    $.event = {
        ...
        function(a, b) {
            ...
            function d(a, b, d, e, f, g) {
                ...
                return i || fa.error(b), (a || !(h = f)) && c(a || "*", e, h = [], f), h.length > 0 ? i(h, d, g) : []
            }
            ...
            function e(a, e, f, g, h) {
                for (var i, j, k, l, m, n, o, p, q = 0, r = h.length, s = S.POS, t = new RegExp("^" + s.source + "(?!" + y + ")", "i"), u = function() {
                    ...
                    m ? (l = l.concat(m), (o = a.slice(k)) && ")" !== o ? I.test(o) ? c(o, l, f, g) : fa(o, e, f, g ? g.concat(m) : m) : w.apply(f, l)) : fa(a, e, f, g)
                }
            ...
            function f(a, b, c) {
                for (var d, e, f, g = [], h = 0, i = K.exec(a), j = !i.pop() && !i.pop(), k = j && a.match(J) || [""], l = ga.preFilter, m = ga.filter, n = !c && b !== p; null != (e = k[h]) && j; h++)
                    for (g.push(d = []), n && (e = " " + e); e;) {
                        ...
                        for (f in m)(i = S[f].exec(e)) && (!l[f] || (i = l[f](i, b, c))) && (e = e.slice(i.shift().length), j = d.push({
                            part: f,
                            captures: i
                        }));
                        if (!j) break
            ...
            function g(a, b, c) {
                ...
                return a || (a = function(a) {
                    ...
                    for (; b = b[d];)
                        if (1 === b.nodeType) return a(b, c) && b
                } : function(b, c) {
            ...
            function i(a, b, c) {
                for (var d, e, f = 0; d = a[f]; f++) ga.relative[d.part] ? e = g(e, ga.relative[d.part], b) : (d.captures.push(b, c), e = h(e, ga.filter[d.part].apply(null, d.captures)));
                return e
            }
                ...
                fa = function(a, b, c, d) {
                    ...
                    if (g = ia(b), !g && !d && (e = M.exec(a)))
                        if (h = e[1]) {
                            ...
                            if ((h = e[3]) && ea && b.getElementsByClassName) return w.apply(c, v.call(b.getElementsByClassName(h), 0)), c
                        } return ma(a, b, c, d, g)
                },
                ga = fa.selectors = {
                    cacheLength: 50,
                    ...
                    preFilter: {
                        ...
                        CHILD: function(a) {
                            return a[1] = a[1].toLowerCase(), "nth" === a[1] ? (a[2] || fa.error(a[0]), a[3] = +(a[3] ? a[4] + (a[5] || 1) : 2 * ("even" === a[2] || "odd" === a[2])), a[4] = +(a[6] + a[7] || "odd" === a[2])) : a[2] && fa.error(a[0]), a
                        },
                        PSEUDO: function(a) {
                            var b, c = a[4];
                    ...
                    filter: {
                        ...
                        CLASS: function(a) {
                            var b = T[a];
                            return b || (b = T[a] = new RegExp("(^|" + y + ")" + a + "(" + y + "|$)"), U.push(a), U.length > ga.cacheLength && delete T[U.shift()]),
                                function(a) {
                        ...
                        PSEUDO: function(a, b, c, d) {
                            ...
                            return e || fa.error("unsupported pseudo: " + a), e.sizzleFilter ? e(b, c, d) : e
                        }
                    },
                    pseudos: {
            ...
            ga.setFilters.nth = ga.setFilters.eq, ga.filters = ga.pseudos, da || (ga.attrHandle = {
                href: function(a) {
            ...
            }), ba && (ga.order.push("NAME"), ga.find.NAME = function(a, b) {
                return typeof b.getElementsByName !== r ? b.getElementsByName(a) : void 0
            }), ea && (ga.order.splice(1, 0, "CLASS"), ga.find.CLASS = function(a, b, c) {
            ...
            fa.attr = function(a, b) {
                var c, d = ia(a);
                return d || (b = b.toLowerCase()), ga.attrHandle[b] ? ga.attrHandle[b](a) : aa || d ? a.getAttribute(b) : (c = a.getAttributeNode(b), c ? "boolean" == typeof a[b] ? a[b] ? b : null : c.specified ? c.value : null : null)
            }, fa.error = function(a) {
            ...
            var la = fa.compile = function(a, b, c) {
                ...
                return h = V[a] = j(e), h.context = b, h.runs = h.dirruns = 0, W.push(a), W.length > ga.cacheLength && delete V[W.shift()], h
            };
            ...
            var ma = function(a, b, c, d, f) {
                a = a.replace(H, "$1");
                var g, h, i, j, m, n, o, p, q, r = a.match(J),
                    s = a.match(L),
                    t = b.nodeType;
                ...
                if (d) g = v.call(d, 0);
                    ...
                    for (p = (r = N.exec(s[0])) && !r.index && b.parentNode || b, q = s.pop(), n = q.split(":not")[0], i = 0, j = ga.order.length; j > i; i++)
                        if (o = ga.order[i], r = S[o].exec(n)) {
                            if (g = ga.find[o]((r[1] || "").replace(R, ""), p, f), null == g) continue;
                            n === q && (a = a.slice(0, a.length - q.length) + n.replace(S[o], ""), a || w.apply(c, v.call(g, 0)));
                            break
                        }
                }
                if (a)
                    for (h = la(a, b, f), l = h.dirruns++, null == g && (g = ga.find.TAG("*", N.test(a) && b.parentNode || b)), i = 0; m = g[i]; i++) k = h.runs++, h(m, b) && c.push(m);
                return c
            };
            p.querySelectorAll && function() {
                var a, b = ma,
                    ...
                    e = [],
                    f = [":active"],
                    g = q.matchesSelector || q.mozMatchesSelector || q.webkitMatchesSelector || q.oMatchesSelector || q.msMatchesSelector;
                _(function(a) {
                ...
                }), e = e.length && new RegExp(e.join("|")), ma = function(a, d, f, g, h) {
                    if (!(g || h || e && e.test(a)))
                        if (9 === d.nodeType) try {
                            return w.apply(f, v.call(d.querySelectorAll(a), 0)), f
                        } catch (i) {} else if (1 === d.nodeType && "object" !== d.nodeName.toLowerCase()) {
                ...
                }), f = new RegExp(f.join("|")), fa.matchesSelector = function(b, c) {
                    if (c = c.replace(d, "='$1']"), !(ia(b) || f.test(c) || e && e.test(c))) try {
                        var h = g.call(b, c);
                        if (h || a || b.document && 11 !== b.document.nodeType) return h
                    } catch (i) {}
                    return fa(c, null, null, [b]).length > 0
                })
            }(), fa.attr = $.attr, $.find = fa, $.expr = fa.selectors, $.expr[":"] = $.expr.pseudos, $.unique = fa.uniqueSort, $.text = fa.getText, $.isXMLDoc = fa.isXML, $.contains = fa.contains
        }(a);
    var Ia = /Until$/,
    ...
    _a.optgroup = _a.option, _a.tbody = _a.tfoot = _a.colgroup = _a.caption = _a.thead, _a.th = _a.td, $.support.htmlSerialize || (_a._default = [1, "X<div>", "</div>"]), $.fn.extend({
            ...
            var e, f, g, h = a[0];
            return c = c || P, c = (c[0] || c).ownerDocument || c[0] || c, "undefined" == typeof c.createDocumentFragment && (c = P), 1 === a.length && "string" == typeof h && h.length < 512 && c === P && "<" === h.charAt(0) && !Va.test(h) && ($.support.checkClone || !Ya.test(h)) && ($.support.html5Clone || !Wa.test(h)) && (f = !0, e = $.fragments[h], g = e !== b), e || (e = c.createDocumentFragment(), $.clean(a, c, e, d), f && ($.fragments[h] = g && e)), {
                fragment: e,
                cacheable: f
            }
        }, $.fragments = {}, $.each({
            ...
            clean: function(a, b, c, d) {
                var e, f, g, h, i, j, l, m, n, o, q, r = 0,
                    s = [];
                for (b && "undefined" != typeof b.createDocumentFragment || (b = P), f = b === P && ab; null != (g = a[r]); r++)
                    if ("number" == typeof g && (g += ""), g) {
                        if ("string" == typeof g)
                            if (Ta.test(g)) {
                                for (f = f || k(b), l = l || f.appendChild(b.createElement("div")), g = g.replace(Qa, "<$1></$2>"), h = (Ra.exec(g) || ["", ""])[1].toLowerCase(), i = _a[h] || _a._default, j = i[0], l.innerHTML = i[1] + g + i[2]; j--;) l = l.lastChild;
                                if (!$.support.tbody)
                                    for (m = Sa.test(g), n = "table" !== h || m ? "<table>" !== i[1] || m ? [] : l.childNodes : l.firstChild && l.firstChild.childNodes, e = n.length - 1; e >= 0; --e) $.nodeName(n[e], "tbody") && !n[e].childNodes.length && n[e].parentNode.removeChild(n[e]);
                                !$.support.leadingWhitespace && Pa.test(g) && l.insertBefore(b.createTextNode(Pa.exec(g)[0]), l.firstChild), g = l.childNodes, l = f.lastChild
                            } else g = b.createTextNode(g);
                        g.nodeType ? s.push(g) : s = $.merge(s, g)
                    } if (l && (f.removeChild(l), g = l = f = null), !$.support.appendChecked)
                    for (r = 0; null != (g = s[r]); r++) $.nodeName(g, "input") ? p(g) : "undefined" != typeof g.getElementsByTagName && $.grep(g.getElementsByTagName("input"), p);
                if (c)
                    for (o = function(a) {
    ...
    $.fn.extend({
        ...
        style: function(a, c, d, e) {
            if (a && 3 !== a.nodeType && 8 !== a.nodeType && a.style) {
                ...
                if (g = typeof d, "string" === g && (f = lb.exec(d)) && (d = (f[1] + 1) * f[2] + parseFloat($.css(a, c)), g = "number"), !(null == d || "number" === g && isNaN(d) || ("number" === g && !$.cssNumber[i] && (d += "px"), h && "set" in h && (d = h.set(a, d, e)) === b))) try {
                    j[c] = d
                } catch (k) {}
            }
        },
        css: function(a, c, d, e) {
            var f, g, h, i = $.camelCase(c);
            return c = $.cssProps[i] || ($.cssProps[i] = q(a.style, i)), h = $.cssHooks[c] || $.cssHooks[i], h && "get" in h && (f = h.get(a, !0, e)), f === b && (f = cb(a, c)), "normal" === f && c in ob && (f = ob[c]), d || e !== b ? (g = parseFloat(f), d || $.isNumeric(g) ? g || 0 : f) : f
        },
        swap: function(a, b, c) {
            var d, e, f = {};
        ...
        var c, d, e, f, g = getComputedStyle(a, null),
            h = a.style;
        return g && (c = g[b], "" === c && !$.contains(a.ownerDocument.documentElement, a) && (c = $.style(a, b)), kb.test(c) && ib.test(b) && (d = h.width, e = h.minWidth, f = h.maxWidth, h.minWidth = h.maxWidth = h.width = c, c = g.width, h.width = d, h.minWidth = e, h.maxWidth = f)), c
    } : P.documentElement.currentStyle && (cb = function(a, b) {
        var c, d, e = a.currentStyle && a.currentStyle[b],
            f = a.style;
        return null == e && f && f[b] && (e = f[b]), kb.test(e) && !hb.test(b) && (c = f.left, d = a.runtimeStyle && a.runtimeStyle.left, d && (a.runtimeStyle.left = a.currentStyle.left), f.left = "fontSize" === b ? "1em" : e, e = f.pixelLeft + "px", f.left = c, d && (a.runtimeStyle.left = d)), "" === e ? "auto" : e
    }), $.each(["height", "width"], function(a, b) {
        $.cssHooks[b] = {
            get: function(a, c, d) {
                return c ? 0 !== a.offsetWidth || "none" !== cb(a, "display") ? v(a, b, d) : $.swap(a, nb, function() {
                    return v(a, b, d)
                }) : void 0
            },
            set: function(a, c, d) {
    ...
    yb = Hb.exec(xb.toLowerCase()) || [], $.fn.load = function(a, c, d) {
        ...
        return i >= 0 && (e = a.slice(i, a.length), a = a.slice(0, i)), $.isFunction(c) ? (d = c, c = b) : "object" == typeof c && (f = "POST"), $.ajax({
            ...
            g = arguments, h.html(e ? $("<div>").append(a.replace(Fb, "")).find(e) : a)
        }), this
        ...
        ajax: function(a, c) {
            ...
            if (p.promise(w), w.success = w.done, w.error = w.fail, w.complete = q.add, w.statusCode = function(a) {
                    ...
                    return this
                }, m.url = ((a || m.url) + "").replace(zb, "").replace(Db, yb[1] + "//"), m.dataTypes = $.trim(m.dataType || "*").toLowerCase().split(ba), null == m.crossDomain && (j = Hb.exec(m.url.toLowerCase()), m.crossDomain = !(!j || j[1] == yb[1] && j[2] == yb[2] && (j[3] || ("http:" === j[1] ? 80 : 443)) == (yb[3] || ("http:" === yb[1] ? 80 : 443)))), m.data && m.processData && "string" != typeof m.data && (m.data = $.param(m.data, m.traditional)), z(Jb, m, c, w), 2 === u) return w;
            if (k = m.global, m.type = m.type.toUpperCase(), m.hasContent = !Cb.test(m.type), k && 0 === $.active++ && $.event.trigger("ajaxStart"), !m.hasContent && (m.data && (m.url += (Eb.test(m.url) ? "&" : "?") + m.data, delete m.data), e = m.url, m.cache === !1)) {
                var x = $.now(),
                    y = m.url.replace(Gb, "$1_=" + x);
                m.url = y + (y === m.url ? (Eb.test(m.url) ? "&" : "?") + "_=" + x : "")
            }(m.data && m.hasContent && m.contentType !== !1 || c.contentType) && w.setRequestHeader("Content-Type", m.contentType), m.ifModified && (e = e || m.url, $.lastModified[e] && w.setRequestHeader("If-Modified-Since", $.lastModified[e]), $.etag[e] && w.setRequestHeader("If-None-Match", $.etag[e])), w.setRequestHeader("Accept", m.dataTypes[0] && m.accepts[m.dataTypes[0]] ? m.accepts[m.dataTypes[0]] + ("*" !== m.dataTypes[0] ? ", " + Lb + "; q=0.01" : "") : m.accepts["*"]);
    ...
    $.ajaxSetup({
        ...
        return "jsonp" === c.dataTypes[0] || l || m ? (f = c.jsonpCallback = $.isFunction(c.jsonpCallback) ? c.jsonpCallback() : c.jsonpCallback, g = a[f], l ? c.url = j.replace(Pb, "$1" + f) : m ? c.data = i.replace(Pb, "$1" + f) : k && (c.url += (Ob.test(j) ? "&" : "?") + c.jsonp + "=" + f), c.converters["script json"] = function() {
    ...
    $.Animation = $.extend(H, {
        tweener: function(a, b) {
            ...
            for (var c, d = 0, e = a.length; e > d; d++) c = a[d], $b[c] = $b[c] || [], $b[c].unshift(b)
        },
    ...
    $.fn.offset = function(a) {
        ...
        var c, d, e, f, g, h, i, j, k, l, m = this[0],
            n = m && m.ownerDocument;
        if (n) return (e = n.body) === m ? $.offset.bodyOffset(m) : (d = n.documentElement, $.contains(d, m) ? (c = m.getBoundingClientRect(), f = M(n), g = d.clientTop || e.clientTop || 0, h = d.clientLeft || e.clientLeft || 0, i = f.pageYOffset || d.scrollTop, j = f.pageXOffset || d.scrollLeft, k = c.top + i - g, l = c.left + j - h, {
            top: k,
            left: l
        }) : {
            top: 0,
...
var googlefonts = {
    ...
    items: [{
        ...
        subsets: ["cyrillic", "latin", "greek-ext", "greek", "latin-ext", "vietnamese", "cyrillic-ext"],
        version: "v10",
        ...
        category: "sans-serif",
        variants: ["regular", "italic", "700", "700italic"],
        subsets: ["cyrillic", "latin", "greek-ext", "hebrew", "greek", "latin-ext", "vietnamese", "cyrillic-ext"],
        version: "v11",
        ...
        category: "display",
        variants: ["300", "regular", "700"],
        subsets: ["cyrillic", "latin", "greek", "latin-ext", "vietnamese", "cyrillic-ext"],
        version: "v12",
        lastModified: "2017-11-07",
        files: {
        ...
        category: "sans-serif",
        variants: ["regular"],
        subsets: ["cyrillic", "latin", "greek-ext", "greek", "latin-ext", "cyrillic-ext"],
        version: "v11",
        lastModified: "2017-10-10",
        files: {
        ...
        category: "sans-serif",
        variants: ["regular", "italic", "700", "700italic"],
        subsets: ["devanagari", "cyrillic", "latin", "greek-ext", "greek", "latin-ext", "vietnamese", "cyrillic-ext"],
        version: "v7",
        lastModified: "2017-10-11",
        files: {
        ...
        family: "Vollkorn",
        category: "serif",
        variants: ["regular", "italic", "600", "600italic", "700", "700italic", "900", "900italic"],
        subsets: ["cyrillic", "latin", "greek", "latin-ext", "vietnamese", "cyrillic-ext"],
        version: "v8",
        lastModified: "2017-11-21",
        files: {
...
function(a, b) {
    ...
    function c(a, b) {
        ...
        if (a.constructor === String) {
            for (; e > d; d += 1)
                if (0 === a.localeCompare(b[d])) return d
        } else
            for (; e > d; d += 1)
    ...
    function d(a, c) {
        return a === c ? !0 : a === b || c === b ? !1 : null === a || null === c ? !1 : a.constructor === String ? 0 === a.localeCompare(c) : c.constructor === String ? 0 === c.localeCompare(a) : !1
    }
    ...
    function n(a, b, c) {
        var d = a.toUpperCase().indexOf(b.toUpperCase()),
            e = b.length;
        return 0 > d ? void c.push(a) : (c.push(a.substring(0, d)), c.push("<span class='select2-match'>"), c.push(a.substring(d, d + e)), c.push("</span>"), void c.push(a.substring(d + e, a.length)))
    }
        ...
        return function(g) {
            window.clearTimeout(c), c = window.setTimeout(function() {
                ...
                var c = d,
                    ...
                    i = b.traditional || !1,
                    j = b.type || "GET";
                f = f.call(this, g.term, g.page, g.context), null !== e && e.abort(), e = h.call(null, {
                    url: b.url,
                    dataType: b.dataType,
                    data: f,
                    type: j,
    ...
    function p(b) {
        ...
        return a.isArray(d) || (e = d.text, a.isFunction(e) || (c = d.text, e = function(a) {
                return a[c]
            }), d = d.results),
            function(b) {
                var c, f = b.term,
                ...
                return "" === f ? void b.callback({
                    ...
                    if (d = d[0], d.children) {
                        ...
                        h.children = [], a(d.children).each2(function(a, b) {
                            c(b, h.children)
    ...
    function q(c) {
        return a.isFunction(c) ? c : function(d) {
            var e = d.term,
                f = {
                    results: []
                };
            a(c).each(function() {
                var a = this.text !== b,
                    c = a ? this.text : this;
                ("" === e || d.matcher(e, c)) && f.results.push(a ? this : {
                    id: this,
                    text: this
                })
            }), d.callback(f)
    ...
    function u(a, c, e, f) {
        ...
        for (;;) {
            ...
            if (0 > h) break;
            if (g = a.substring(0, h), a = a.substring(h + k.length), g.length > 0 && (g = f.createSearchChoice(g, c), g !== b && null !== g && f.id(g) !== b && null !== f.id(g))) {
    ...
    if (window.Select2 === b) {
        ...
        w = {
            ...
            a(document).delegate("body", "mousedown touchend", function(c) {
                var d, e = a(c.target).closest("div.select2-container").get(0);
                e ? a(document).find("div.select2-container-active").each(function() {
                    this !== e && a(this).data("select2").blur()
                }) : (e = a(c.target).closest("div.select2-drop").get(0), a(document).find("div.select2-drop-active").each(function() {
                    this !== e && a(this).data("select2").blur()
                })), e = a(c.target), d = e.attr("for"), "LABEL" === c.target.tagName && d && d.length > 0 && (e = a("#" + d), e = e.data("select2"), e !== b && (e.focus(), c.preventDefault()))
            })
        }), x = v(Object, {
            bind: function(a) {
                var b = this;
                ...
                if (f = c.element, "select" === f.get(0).tagName.toLowerCase() && (this.select = g = c.element), g && a.each(["id", "multiple", "ajax", "query", "createSearchChoice", "initSelection", "data", "tags"], function() {
                        ...
                        populateResults: function(d, e, f) {
                            ...
                            (g = function(d, e, j) {
                                ...
                                for (k = 0, l = d.length; l > k; k += 1) m = d[k], n = h(m) !== b, o = m.children && m.children.length > 0, p = a("<li></li>"), p.addClass("select2-results-dept-" + j), p.addClass("select2-result"), p.addClass(n ? "select2-result-selectable" : "select2-result-unselectable"), o && p.addClass("select2-result-with-children"), p.attr("style", i.opts.formatResultCssClass(m)), q = a("<div></div>"), q.addClass("select2-result-label"), s = c.formatResult(m, q, f), s !== b && q.html(i.opts.escapeMarkup(s)), p.append(q), o && (r = a("<ul></ul>"), r.addClass("select2-result-sub"), g(m.children, r, j + 1), p.append(r)), p.data("select2-data", m), e.append(p)
                            })(e, d, 0)
                        }
                    }, a.fn.select2.defaults, c), "function" != typeof c.id && (h = c.id, c.id = function(a) {
                        return a[h]
                    }), g ? (c.query = this.bind(function(c) {
                        var d, e, g, h = {
                                results: [],
                                more: !1
                            },
                        ...
                        g = function(a, b) {
                            var d;
                            a.is("option") ? c.matcher(i, a.text(), a) && b.push({
                                id: a.attr("value"),
                                text: a.text(),
                                element: a.get(),
                                css: a.attr("style")
                        ...
                        }, d = f.children(), this.getPlaceholder() !== b && d.length > 0 && (e = d[0], "" === a(e).text() && (d = d.not(e))), d.each2(function(a, b) {
                            g(b, h.results)
                        }), c.callback(h)
                    }), c.id = function(a) {
                        return a.id
                        ...
                        return a.css
                    }) : "query" in c || ("ajax" in c ? (i = c.element.data("ajax-url"), i && i.length > 0 && (c.ajax.url = i), c.query = o(c.ajax)) : "data" in c ? c.query = p(c.data) : "tags" in c && (c.query = q(c.tags), c.createSearchChoice = function(a) {
                        return {
                            id: a,
                            text: a
                        }
                        ...
                        a(e(b.val(), c.separator)).each(function() {
                            ...
                            a.isFunction(f) && (f = f()), a(f).each(function() {
                                return d(this.id, b) ? (e = this.text, !1) : void 0
                            }), g.push({
                                id: b,
                                text: e
                            })
            ...
            positionDropdown: function() {
                ...
                "static" !== this.body().css("position") && (b = this.body().offset(), j -= b.top, k -= b.left), n ? (c = !0, !m && l && (c = !1)) : (c = !1, !l && m && (c = !0)), c ? (j = e.top - h, this.container.addClass("select2-drop-above"), this.dropdown.addClass("select2-drop-above")) : (this.container.removeClass("select2-drop-above"), this.dropdown.removeClass("select2-drop-above")), d = a.extend({
                    top: j,
                    left: k,
                    width: g
                }, s(this.opts.dropdownCss)), this.dropdown.css(d)
            },
            shouldOpen: function() {
                var b;
                return this.opened() ? !1 : (b = a.Event("open"), this.opts.element.trigger(b), !b.isDefaultPrevented())
            },
            ...
            ensureHighlightVisible: function() {
                ...
                if (c = this.highlight(), !(0 > c)) {
                    ...
                    b = i.find(".select2-result-selectable"), d = a(b[c]), e = d.offset().top + d.outerHeight(), c === b.length - 1 && (h = i.find("li.select2-more-results"), h.length > 0 && (e = h.offset().top + h.outerHeight())), f = i.offset().top + i.outerHeight(), e > f && i.scrollTop(i.scrollTop() + (e - f)), g = d.offset().top - i.offset().top, 0 > g && i.scrollTop(i.scrollTop() + g)
                }
            },
            moveHighlight: function(b) {
                for (var c = this.results.find(".select2-result-selectable"), d = this.highlight(); d > -1 && d < c.length;) {
                    d += b;
                    var e = a(c[d]);
            ...
            highlight: function(b) {
                var d = this.results.find(".select2-result-selectable").not(".select2-disabled");
                if (0 === arguments.length) return c(d.filter(".select2-highlighted")[0], d.get());
                b >= d.length && (b = d.length - 1), 0 > b && (b = 0);
                for (var e = (d.length - b, 8), f = 8, g = b - e; b + f + 1 > g; g++)
                    if (!(0 > g || g > d.length - 1)) {
                        var h = a(d[g]).text();
                        h.match(/^\d/) ? a(d[g]).css("font-family", "") : a(d[g]).css("font-family", h)
                    } d.removeClass("select2-highlighted"), a(d[b]).addClass("select2-highlighted"), this.ensureHighlightVisible(), this.opts.element.trigger("highlight-change", a(d[b]).text())
            },
            ...
            loadMoreIfNeeded: function() {
                var a, b = this.results,
                    ...
                    f = this.search.val(),
                    g = this.context;
                0 !== c.length && (a = c.offset().top - b.offset().top - b.height(), 0 >= a && (c.addClass("select2-active"), this.opts.query({
                    term: f,
                    page: d,
                    context: g,
                    ...
                    callback: this.bind(function(a) {
                        e.opened() && (e.opts.populateResults.call(this, b, a.results, {
                            ...
                            page: d,
                            context: g
                        }), a.more === !0 ? (c.detach().appendTo(b).text(e.opts.formatLoadMore(d + 1)), window.setTimeout(function() {
                            e.loadMoreIfNeeded()
                        }, 10)) : c.remove(), e.positionDropdown(), e.resultsPage = d)
                    })
                })))
            },
            tokenize: function() {},
            updateResults: function(c) {
                ...
                if (c === !0 || this.showSearchInput !== !1 && this.opened()) {
                    if (i.addClass("select2-active"), k.maximumSelectionSize >= 1 && (g = this.data(), a.isArray(g) && g.length >= k.maximumSelectionSize && r(k.formatSelectionTooBig, "formatSelectionTooBig"))) return void f("<li class='select2-selection-limit'>" + k.formatSelectionTooBig(k.maximumSelectionSize) + "</li>");
                    if (i.val().length < k.minimumInputLength && r(k.formatInputTooShort, "formatInputTooShort")) return void f("<li class='select2-no-results'>" + k.formatInputTooShort(i.val(), k.minimumInputLength) + "</li>");
                    f("<li class='select2-searching'>" + k.formatSearching() + "</li>"), h = this.tokenize(), h != b && null != h && i.val(h), this.resultsPage = 1, k.query({
                        term: i.val(),
                        ...
                        callback: this.bind(function(g) {
                            var h;
                            if (this.opened()) {
                                if (this.context = g.context === b ? null : g.context, this.opts.createSearchChoice && "" !== i.val() && (h = this.opts.createSearchChoice.call(null, i.val(), g.results), h !== b && null !== h && l.id(h) !== b && null !== l.id(h) && 0 === a(g.results).filter(function() {
                                        return d(l.id(this), l.id(h))
                                    }).length && g.results.unshift(h)), 0 === g.results.length && r(k.formatNoMatches, "formatNoMatches")) return void f("<li class='select2-no-results'>" + k.formatNoMatches(i.val()) + "</li>");
                                j.empty(), l.opts.populateResults.call(this, j, g.results, {
                                    term: i.val(),
                                    page: this.resultsPage,
                                    context: null
                                }), g.more === !0 && r(k.formatLoadMore, "formatLoadMore") && (j.append("<li class='select2-more-results'>" + l.opts.escapeMarkup(k.formatLoadMore(this.resultsPage)) + "</li>"), window.setTimeout(function() {
                                    l.loadMoreIfNeeded()
            ...
            selectHighlighted: function() {
                var a = (this.highlight(), this.results.find(".select2-highlighted").not(".select2-disabled")),
            ...
            initContainerWidth: function() {
                function c() {
                    ...
                    if ("copy" === this.opts.width || "resolve" === this.opts.width) {
                        ...
                        return "resolve" === this.opts.width ? (c = this.opts.element.css("width"), c.indexOf("%") > 0 ? c : 0 === this.opts.element.outerWidth() ? "auto" : this.opts.element.outerWidth() + "px") : null
                    }
            ...
            createContainer: function() {
                ...
                return b.find("a").click(function() {
                    return !1
                }), b
            },
            opening: function() {
            ...
            initContainer: function() {
                ...
                this.selection = a = b.find(".select2-choice"), this.search.bind("keydown", this.bind(function(a) {
                    if (this.enabled) {
                        if (a.which === w.PAGE_UP || a.which === w.PAGE_DOWN) return void l(a);
                        if (this.opened()) switch (a.which) {
                            case w.UP:
                            case w.DOWN:
                                return this.moveHighlight(a.which === w.UP ? -1 : 1), void l(a);
                            case w.TAB:
                            case w.ENTER:
                            ...
                            if (a.which === w.TAB || w.isControl(a) || w.isFunctionKey(a) || a.which === w.ESC) return;
                            if (this.opts.openOnEnter === !1 && a.which === w.ENTER) return;
                    ...
                    d = !0, this.opened() ? (this.close(), this.selection.focus()) : (this.enabled || (this.enable(), this.opts.element.trigger("enabled")), this.open()), d = !1
                })), c.bind("mousedown", this.bind(function() {
                    this.search.focus()
                    ...
                    if (this.enabled) {
                        if (a.which === w.PAGE_UP || a.which === w.PAGE_DOWN) return void l(a);
                        if (!(a.which === w.TAB || w.isControl(a) || w.isFunctionKey(a) || a.which === w.ESC || this.opts.openOnEnter === !1 && a.which === w.ENTER)) {
                            if (a.which == w.DELETE) return void(this.opts.allowClear && this.clear());
                            if (this.open(), a.which === w.ENTER) return void l(a);
                            if (a.which < 48) return void l(a);
                            var b = String.fromCharCode(a.which).toLowerCase();
                            a.shiftKey && (b = b.toUpperCase()), this.search.focus(), this.search.val(b), l(a)
                        }
                    }
            ...
            postprocessResults: function(b, c) {
                ...
                this.results.find(".select2-result-selectable").each2(function(a, b) {
                    return d(f.id(b.data("select2-data")), f.opts.element.val()) ? (e = a, !1) : void 0
                }), this.highlight(e), c === !0 && (g = this.showSearchInput = t(b.results) >= this.opts.minimumResultsForSearch, this.dropdown.find(".select2-search")[g ? "removeClass" : "addClass"]("select2-search-hidden"), a(this.dropdown, this.container)[g ? "addClass" : "removeClass"]("select2-with-searchbox"))
            },
            onSelect: function(a) {
                var b = this.opts.element.val();
                this.opts.element.val(this.id(a)), this.updateSelection(a), this.close(), this.selection.focus(), d(b, this.id(a)) || this.triggerChange()
            },
            updateSelection: function(a) {
                var c, d = this.selection.find("span");
                this.selection.data("select2-data", a), d.empty(), c = this.opts.formatSelection(a, d), c !== b && (d.append(this.opts.escapeMarkup(c)), c.match(/^\d/) ? d.css("font-family", "") : d.css("font-family", c)), this.selection.removeClass("select2-default"), this.opts.allowClear && this.getPlaceholder() !== b && this.selection.find("abbr").show()
            },
            val: function() {
                var a, c = null,
                    d = this;
                if (0 === arguments.length) return this.opts.element.val();
                if (a = arguments[0], this.select) this.select.val(a).find(":selected").each2(function(a, b) {
                    return c = {
                        id: b.attr("value"),
                        text: b.text(),
                        css: b.attr("style")
            ...
            data: function(a) {
                var c;
                return 0 === arguments.length ? (c = this.selection.data("select2-data"), c == b && (c = null), c) : void(a && "" !== a ? (this.opts.element.val(a ? this.id(a) : ""), this.updateSelection(a)) : this.clear())
            }
        }), z = v(x, {
            createContainer: function() {
                var b = a("<div></div>", {
            ...
            initContainer: function() {
                ...
                this.searchContainer = this.container.find(".select2-search-field"), this.selection = b = this.container.find(c), this.search.bind("keydown", this.bind(function(a) {
                    if (this.enabled) {
                        if (a.which === w.BACKSPACE && "" === this.search.val()) {
                            this.close();
                            var c, d = b.find(".select2-search-choice-focus");
                            if (d.length > 0) return this.unselect(d.first()), this.search.width(10), void l(a);
                            c = b.find(".select2-search-choice"), c.length > 0 && c.last().addClass("select2-search-choice-focus")
                        } else b.find(".select2-search-choice-focus").removeClass("select2-search-choice-focus");
                        if (this.opened()) switch (a.which) {
                            case w.UP:
                            case w.DOWN:
                                return this.moveHighlight(a.which === w.UP ? -1 : 1), void l(a);
                        ...
                        a.which === w.TAB || w.isControl(a) || w.isFunctionKey(a) || a.which === w.BACKSPACE || a.which === w.ESC || (this.opts.openOnEnter !== !1 || a.which !== w.ENTER) && (this.open(), (a.which === w.PAGE_UP || a.which === w.PAGE_DOWN) && l(a))
                    }
                ...
                })), this.container.delegate(c, "mousedown", this.bind(function(b) {
                ...
                })), this.container.delegate(c, "focus", this.bind(function() {
            ...
            clearSearch: function() {
                var a = this.getPlaceholder();
                a !== b && 0 === this.getVal().length && this.search.hasClass("select2-focused") === !1 ? (this.search.val(a).addClass("select2-default"), this.resizeSearch()) : this.search.val(" ").width(10)
            },
            ...
            onSelect: function(a) {
                this.addSelectedChoice(a), this.select && this.postprocessResults(), this.opts.closeOnSelect ? (this.close(), this.search.width(10)) : this.countSelectableResults() > 0 ? (this.search.width(10), this.resizeSearch(), this.positionDropdown()) : this.close(), this.triggerChange({
                    added: a
                }), this.focusSearch()
            },
            cancel: function() {
            ...
            addSelectedChoice: function(b) {
                var c, d = a("<li class='select2-search-choice'>    <div></div>    <a href='#' class='select2-search-choice-close' tabindex='-1'></a></li>"),
                    e = this.id(b),
                    f = this.getVal();
                d.find("a").click(function() {
                    return !1
                }), c = this.opts.formatSelection(b, d), d.find("div").replaceWith("<div>" + this.opts.escapeMarkup(c) + "</div>"), d.find(".select2-search-choice-close").bind("mousedown", l).bind("click dblclick", this.bind(function(b) {
                ...
                })), d.data("select2-data", b), d.insertBefore(this.searchContainer), f.push(e), this.setVal(f)
            },
            unselect: function(a) {
                ...
                b = a.data("select2-data"), d = c(this.id(b), e), d >= 0 && (e.splice(d, 1), this.setVal(e), this.select && this.postprocessResults()), a.remove(), this.triggerChange({
                    removed: b
                })
            },
            postprocessResults: function() {
                ...
                b.each2(function(b, d) {
                    ...
                    c(f, a) >= 0 ? d.addClass("select2-disabled").removeClass("select2-result-selectable") : d.removeClass("select2-disabled").addClass("select2-result-selectable")
                    ...
                    return !b.hasClass("select2-disabled") && b.hasClass("select2-result-selectable") ? (e.highlight(0), !1) : void 0
                })
            },
            resizeSearch: function() {
                var a, b, c, d, e, g = f(this.search);
                a = m(this.search) + 10, b = this.search.offset().left, c = this.selection.width(), d = this.selection.offset().left, e = c - (b - d) - g, a > e && (e = c - g), 40 > e && (e = c - g), this.search.width(e)
            },
            getVal: function() {
                var a;
            ...
            val: function() {
                ...
                if (c = arguments[0], !c) return this.opts.element.val(""), this.updateSelection([]), void this.clearSearch();
                if (this.setVal(c), this.select) this.select.find(":selected").each(function() {
                    d.push({
            ...
            data: function(b) {
                ...
                }).get() : (b || (b = []), c = a.map(b, function(a) {
                    return d.opts.id(a)
                }), this.setVal(c), this.updateSelection(b), this.clearSearch(), void 0)
            }
            ...
            return this.each(function() {
                if (0 === h.length || "object" == typeof h[0]) d = 0 === h.length ? {} : a.extend({}, h[0]), d.element = a(this), "select" === d.element.get(0).tagName.toLowerCase() ? g = d.element.attr("multiple") : (g = d.multiple || !1, "tags" in d && (d.multiple = g = !0)), e = g ? new z : new y, e.init(d);
                else {
                    ...
                    if (f = "container" === h[0] ? e.container : e[h[0]].apply(e, h.slice(1)), f !== b) return !1
                }
            }), f === b ? this : f
    ...
    var l = function() {
            chrome.storage.local.get("styles", function(a) {
                a || (a = {}), a.styles || (a.styles = {}), a.styles.domain_styles || (a.styles.domain_styles = {}), a.styles.global_style || (a.styles.global_style = {});
                var b = i.url.match(/:\/\/(.[^\/]+)/)[1];
                "custom" === j.type ? a.styles.domain_styles[b] = j : delete a.styles.domain_styles[b], a.styles.global_style = k, chrome.storage.local.set(a)
            })
        },
        m = function() {
            chrome.storage.local.get("styles", function(a) {
                var b = i.url.match(/:\/\/(.[^\/]+)/)[1];
                a && a.styles && (a.styles.domain_styles && a.styles.domain_styles[b] && (j = a.styles.domain_styles[b]), a.styles.global_style && (k = a.styles.global_style));
                var c = null;
                "global" === j.type ? (c = k, n(c)) : "custom" == j.type && (c = j, n(c)), $(".setting-type").val(j.type).trigger("change")
            })
        },
        n = function(i) {
            i.font_style ? (c.select2("val", i.font_style), d.attr("checked", "checked"), c.select2("enable")) : (c.val("normal"), d.removeAttr("checked"), c.select2("disable")), i.font_weight ? (e.select2("val", i.font_weight), f.attr("checked", "checked"), e.select2("enable")) : (e.val("normal"), f.removeAttr("checked"), e.select2("disable")), i.font_family.name ? (a.select2("val", i.font_family.name), b.attr("checked", "checked"), a.select2("enable")) : (a.select2("val", null), b.removeAttr("checked"), a.select2("disable")), i.font_size ? (g.val(i.font_size), h.attr("checked", "checked"), g.removeAttr("disabled")) : (g.val(""), h.removeAttr("checked"), g.attr("disabled", "disabled"))
        },
        o = function(a) {
            "global" == j.type ? p(a) : chrome.tabs.sendMessage(i.id, {
                msg: "style",
                value: a
            }, function() {})
        },
        p = function(a) {
            chrome.tabs.query({}, function(b) {
                for (var c in b) chrome.tabs.sendMessage(b[c].id, {
                    msg: "style",
                    value: a
                }, function() {})
            })
        },
        q = ["Arial", "Arial Black", "Verdana", "Geneva", "Helvetica", "Impact", "Helvetica Neue", "Sans-serif", "Georgia", "Lucida Console", "Times New Roman", "Times", "Serif", "Courier New", "Comic Sans MS", "Courier", "Monospace", "Lucida Sans Unicode", "Tahoma", "Trebuchet MS", "Palatino Linotype"],
        r = [];
    ...
    var s = [];
    if (googlefonts)
        for (var t in googlefonts.items) s.push({
    ...
    for (var v in s)
        if (u.push(s[v].name), 30 === u.length) {
            ...
            w.attr("href", ("https:" == document.location.protocol ? "https" : "http") + "://fonts.googleapis.com/css?family=" + u.join("|").replace(/\s/g, "+")), document.head ? $(document.head).append(w) : $(document.documentElement).append(w), u = []
        } w = $('<link type="text/css" rel="stylesheet"> '), w.attr("href", ("https:" == document.location.protocol ? "https" : "http") + "://fonts.googleapis.com/css?family=" + u.join("|").replace(/\s/g, "+")), document.head ? $(document.head).append(w) : $(document.documentElement).append(w);
    var x = r.concat(s),
        y = {};
    chrome.storage.local.get("custom_fonts", function(b) {
        ...
        if (c) {
            ...
            if (Object.keys(c).forEach(function(a) {
                    d += "@font-face{  font-family: '" + a + "';src: url(" + c[a] + ");} ", x.push({
                        name: a,
                        type: "custom",
                        url: c[a]
                    })
                ...
                e.type = "text/css", e.innerText = d, document.head ? document.head.appendChild(e) : document.documentElement.appendChild(e)
            }
        }
        x.sort(function(a, b) {
    ...
    }), e.select2(), c.select2(), chrome.tabs.getSelected(null, function(a) {
        i = a, $(".domain").html("Font Settings for<br />" + i.url.match(/:\/\/(.[^\/]+)/)[1] + ":"), m()
    }), $(".help-tip").tooltip(), $("#custom-font").click(function() {
        chrome.tabs.create({
            url: "/custom_fonts.html"
        })
    }), $(".setting-type").change(function() {
        j.type = $(this).val(), "global" === j.type ? ($(".setting-name").text("Global Font"), n(k), $(".well").show().css("background-color", "whiteSmoke"), o(k)) : "custom" === j.type ? ($(".setting-name").text("Site Font"), n(j), $(".well").show().css("background-color", "transparent"), o(j)) : (j = {
            type: "custom",
            font_family: {
                name: null,
                type: null
        ...
        var a = null;
        a = "global" === j.type ? k : j, $(this).attr("checked") ? (a.font_weight = e.val(), e.select2("enable")) : (a.font_weight = null, e.select2("disable")), o(a), l()
    }), e.bind("enabled", function() {
        f.click()
    }), d.change(function() {
        var a = null;
        a = "global" === j.type ? k : j, $(this).attr("checked") ? (a.font_style = c.val(), c.select2("enable")) : (a.font_style = null, c.select2("disable")), o(a), l()
    }), c.bind("enabled", function() {
        d.click()
    }), $(".enable-text").change(function() {
        var a = $(this).parent().next("td").children(),
            b = null;
        b = "global" === j.type ? k : j, $(this).attr("checked") ? (b[a[0].id] = a.val(), a.removeAttr("disabled")) : (b[a[0].id] = "", a.attr("disabled", "disabled")), o(b), l()
    }), $(".enable-select").change(function() {
        var b = null;
        b = "global" === j.type ? k : j, $(this).attr("checked") ? (b.font_family = {
            name: a.val(),
            type: a.find("option:selected").data("type")
        }, "custom" === b.font_family.type && (b.font_family.url = y[b.font_family.name]), a.select2("enable")) : (b.font_family = {
            name: null,
            type: null
        }, a.select2("disable")), o(b), l()
    }), c.change(function() {
        var a = null;
        a = "global" === j.type ? k : j, a.font_style = $(this).val(), o(a), l()
    }), e.change(function() {
        var a = null;
        a = "global" === j.type ? k : j, a.font_weight = $(this).val(), o(a), l()
    }), g.keyup(function() {
        var a = null;
        a = "global" === j.type ? k : j;
        ...
        b = "global" === j.type ? k : j;
        var c = a.val();
        b.font_family.name = c, b.font_family.type = a.find("option:selected").data("type"), "custom" === b.font_family.type && (b.font_family.url = y[c]), o(b), l()
    }), $(".done").click(function() {
        window.close()
    }), setTimeout(function() {
    ...
    b.prototype = {
        ...
        hide: function() {
            ...
            var c = this.tip();
            return c.removeClass("in"), a.support.transition && this.$tip.hasClass("fade") ? b() : c.remove(), this
        },
        fixTitle: function() {
            var a = this.$element;
